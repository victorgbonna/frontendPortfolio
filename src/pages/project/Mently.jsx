...
export default function Main() {
  return (
    <div className="main">
      <Head>
        <title>Ogbonna Victor: Project 1</title>
        <meta name="viewport" content="initial-scale=1.0, width=device-width" />
      </Head>
      <div className=' bg-gray-700  py-10 px-20 tablet:px-6' id="project1">
        ...
        <h3 className="text-3xl pt-10 text-gray-900 text-left mb-10 font-bold tablet:text-2xl tablet:mb-4">MENTLY</h3>
